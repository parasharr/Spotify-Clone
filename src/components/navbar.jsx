    ...
    return (
        ...
        <div className='w-full flex justify-between items-center font-semibold'>
            ...
            <div className='flex items-center gap-4'>
                ...
                <p className='bg-black py-1 px-3 rounded-2xl text-[15px] cursor-pointer'><a href="https://apps.microsoft.com/detail/9ncbcszsjrsb?hl=en-US&gl=US">Install App</a></p>
